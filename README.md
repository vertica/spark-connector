...
| aws_enable_ssl                                 | String                                              | Whether SSL should be used. Defaults to always using SSL, only change this if using an endpoint that does not use https. This value cannot be set on the session level in Vertica, so must be set seperately. Use ALTER DATABASE <dbname> SET AWSEnableHttps=0 for this.                                                                                                                                                                                                                                                                                                                                                                        | No                                             |                        true |
