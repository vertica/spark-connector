...
Running this will run all unit tests and build the jar to target/scala-2.12/spark-vertica-connector-assembly-3.2.2.jar
...
mkdir lib
cp ../../connector/target/scala-2.12/spark-vertica-connector-assembly-3.2.2.jar lib
sbt run
```
