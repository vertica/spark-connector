...
Running this will run all unit tests and build the jar to target/[SCALA_VERSION]/spark-vertica-connector-assembly-2.0.4.jar
...
mkdir lib
cp ../../connector/target/scala-2.12/spark-vertica-connector-assembly-2.0.4.jar lib
sbt run
```
