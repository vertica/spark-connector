...
case class InvalidWriteStatusTableOption() extends ConnectorError {
  override def getFullContext: String = "The 'write_status_table' param is invalid. Please specify " +
